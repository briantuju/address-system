...
return [
    ...
    | Available themes: dark, minimal, borderless, bootstrap-4, material-ui,
    | wordpress-admin, bulma.
    |
    */
    ...
    */
    ...
    | js package to be there for you. (for e.g. you might use it heavily to
    ...
    */
    ...
    | (for e.g. you might want to use laravel mix) then this can be
    | handy.
